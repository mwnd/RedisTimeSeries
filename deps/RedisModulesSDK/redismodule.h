...
REDISMODULE_API int (*RedisModule_ReplyWithArray)(RedisModuleCtx *ctx, PORT_LONG len) REDISMODULE_ATTR;
...
REDISMODULE_API void (*RedisModule_ReplySetArrayLength)(RedisModuleCtx *ctx, PORT_LONG len) REDISMODULE_ATTR;
